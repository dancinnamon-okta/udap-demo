  ...
  var oktaClientRegJson = {
    ...
    'settings': {
      ...
      'oauthClient': {
        ...
        'response_types': [(ssVerifiedJwtObject.body.grant_types.includes('client_credentials') ? 'token': 'code')],
        'application_type':(ssVerifiedJwtObject.body.grant_types.includes('client_credentials') ? 'service' : 'web'),
