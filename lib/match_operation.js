...
module.exports.matchHandler = async (requestBody) => {
  ...
  try {
    ...
    if(matchParameters.resource.meta && matchParameters.resource.meta["profile:assertedProfile"] == 'http://hl7.org/fhir/us/identity-matching/StructureDefinition/IDI-Patient-L0') {
      minValidationLevel = 0
    }
    else if(matchParameters.resource.meta && matchParameters.resource.meta["profile:assertedProfile"] == 'http://hl7.org/fhir/us/identity-matching/StructureDefinition/IDI-Patient-L1') {
    ...
    return {
      "statusCode": 400,
      "body": {"Error": e.message, "validationScore": e.validationScore}
    }
  }
  ...
  return {
      ...
      statusCode: 200,
      headers: {
        "x-validation-score": validationScore,
...
function validateMatchParameters(resource, minValidationLevel) {
  ...
  if(minValidationLevel == 0 && overallScore < 10) {
  ...
  if(minValidationLevel == 1 && overallScore < 20) {
